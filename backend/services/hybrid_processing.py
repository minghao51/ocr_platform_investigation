...
class HybridProcessingService:
    ...
    def _parse_and_validate_response(
        self, content: str, schema_definition: Dict[str, Any]
    ) -> Dict[str, Any]:
        try:
            ...
            return {"success": False, "error": f"Invalid JSON response: {str(exc)}"}
    ...
    async def process_pdf(
        ...
        **kwargs,
        ...
        layout_context = self._extract_layout_context(pdf_path)
        contact_sheet = self._build_contact_sheet(pdf_path)
        ...
        validation_result = self._parse_and_validate_response(
